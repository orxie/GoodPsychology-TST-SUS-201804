<%@ Page Title="" Language="C#" MasterPageFile="~/Areas/Admin/Views/Shared/ViewMasterAdmin.Master" Inherits="System.Web.Mvc.ViewPage<Model.Banner>" %>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="panel"  runat="server">
								<div class="panel-heading">
									<h3 class="panel-title">添加心理咨询师</h3>
								</div>
								<div class="panel-body"  runat="server">
                                    <form>
									<div class="input-group">
										<input class="form-control" name="PCTAccount" placeholder="账户" type="text">
									</div>
									<br>
									<br>
									<div class="input-group">
										<span class="input-group-addon"><i class="fa fa-user"></i></span>
										<input class="form-control" name="PCTName" placeholder="名字" type="text">
									</div>
									<br>
									<br>
                                    <textarea class="form-control" name="Synopsis" placeholder="咨询师简介" rows="4"></textarea>
                                    <br>
									<br>
                                    <div class="input-group">
										<input class="form-control" name="PCTBirth" placeholder="出生日期" type="text">
									</div>
                                    <br>
									<br>
                                    <div class="input-group">
                                        <select class="form-control" name="Certificate">
										    ...
										    <option value="二级咨询师">二级咨询师</option>
										    <option value="三级咨询师">三级咨询师</option>
									    </select>
									</div>
                                    <br>
									<label class="fancy-radio">
										<input name="PCTSex" value="male" type="radio">
										<span><i></i>男</span>
									</label>
									<label class="fancy-radio">
										<input name="PCTSex" value="female" type="radio">
										<span><i></i>女</span>
									</label>
                                    <br>
									<br>
                                    <div class="input-group">
										<input class="form-control" name="PCTAddress" placeholder="地址" type="text">
									</div>
                                    <br>
									<br>
                                    <div class="input-group">
										<input class="form-control" name="PhoneNum" placeholder="手机" type="text">
									</div>
                                    <br>
									<br>
                                    <div class="input-group">
										<% using (Html.BeginForm("Index", "AdminElements", FormMethod.Post, new { enctype = "multipart/form-data" }))
                                           {%>
						...
						<div class="col-md-6">
							...
							<div class="panel">
								...
								<div class="panel-body">
									...
									<br>
									<div class="input-group">
										<input class="form-control" name="PhoneNum" placeholder="标签" type="text">
									</div>
									<br>
									<br>
							...
							<div class="panel"  runat="server">
								...
								<div class="panel-body"  runat="server">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control" name="BannerNum">
										    <option value="0">第一张Banner</option>
										    <option value="1">第二张Banner</option>
										    <option value="2">第三张Banner</option>
                                            <option value="3">第四张Banner</option>
									    </select>
									</div>
                                        <br>
									    <br>
                                    ...
                                    <%for (int i = 0; i < Banner.Tables[0].Rows.Count; i++)
			                        {
			                        %>
                                        <div class="input-group">
                                        <img src="<%=Url.Content(Banner.Tables[0].Rows[i][1].ToString()) %>" alt="<%=Url.Content(Banner.Tables[0].Rows[i][0].ToString()) %>" class="img-responsive" />
                                        <br>
									    <br>
									</div>
                                    <%}%>
