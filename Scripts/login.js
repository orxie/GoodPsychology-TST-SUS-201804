...
window.Modernizr = function (a, b, c) {
        ...
        v(""), j = l = null, a.attachEvent && function () {
            ...
            d.getCSS = function (a, b) {
                ...
                l.appendChild(r), m.appendChild(o), o.className = r.className, o.id = r.id, o.innerHTML = r.innerHTML
                    .replace(i, "<$1font")
    ...
    function (a, b, c) {
        ...
        function f(a, c, d, e, f, h) {
            ...
            l.src = l.data = c, !s && (l.style.display = "none"), l.width = l.height = "0", a != "object" && (l.type =
                d), l.onload = l.onreadystatechange = i, a == "img" ? l.onerror = i : a == "script" && (l.onerror =
                function () {
                    r.e = r.r = 1, g()
        ...
        H = function (a) {
            ...
            function e(a, b, e, g, h) {
                ...
                if (!i.bypass) {
                    ...
                    e.load(i.url, i.forceCSS || !i.forceJS && /css$/.test(i.url) ? "c" : c, i.noexec), (D(b) || D(j)) &&
                        e.load(function () {
