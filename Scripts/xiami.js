...
$(function(){
	...
	$(".start em").click(function(){
		...
		$(this).css({
		    "background": 'url("../../Content/images/T1X4JEFq8qXXXaYEA_-11-12.gif") no-repeat',
			"color":"transparent"
		});
		...
		/*换右侧图片*/
		$("#canvas1").attr("src",'../../../img/radio/'+sid+'.jpg');
...
function audioPlay(ev){
	$(".iplay").css("background",'url("Content/images/T1oHFEFwGeXXXYdLba-18-18.gif") 0 0');
